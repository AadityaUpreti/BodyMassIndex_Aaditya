    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnCalc) {
            if (validation()) {
                ...
                BMI_Aaditya obj = new BMI_Aaditya();
                ...
                if (res < 18.5) {
                    Toast.makeText(MainActivity_Aaditya.this, "Under Weight", Toast.LENGTH_LONG).show();
                } else if (res >= 18.5 && res <= 24.9) {
                    Toast.makeText(MainActivity_Aaditya.this, "Normal Weight", Toast.LENGTH_LONG).show();
                } else if (res >= 25 && res <= 29.9) {
                    Toast.makeText(MainActivity_Aaditya.this, "Over Weight", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(MainActivity_Aaditya.this, "Obesity", Toast.LENGTH_LONG).show();
                }
            }
        }
